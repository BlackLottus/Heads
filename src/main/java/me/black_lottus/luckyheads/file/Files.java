...
public class Files {
    ...
    public Files(LuckyHeads m, String s, boolean defaults, boolean comments) {
    ...
    public List<String> getList(String s) {
        ...
        for (String st : this.config.getStringList(s)) {
            now.add(st.replaceAll("%version%", LuckyHeads.getInstance().getDescription().getVersion()).replaceAll("&", "§"));
        }
        return now;
    }
